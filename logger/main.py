...
class CameraManager:
    def __init__(self):
        ...
        self.low_res_config = self.camera.create_video_configuration(main={"size": (640, 480)})
        self.high_res_config = self.camera.create_video_configuration(main={"size": (1920, 1080)})
